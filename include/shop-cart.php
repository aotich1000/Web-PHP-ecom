...
?>
    ...
    <div id="main">
            ...
            <table class="table table-striped">
                ...
                foreach ($cart as $key => $value) : ?>
                    <tr>
                        ...
                        <div><a href="" id="xoa" onclick=" return Xoagiohang(<?php echo $value['id'] ?>)"><button class="btn btn-danger" type="submit">Xóa</button></a></div>
                        </th>
                    </tr>
                <?php endforeach ?>
                <tr>
        ...
        <?php if (isset($_SESSION['cart']) && !empty($_SESSION['cart'])) { ?>
            ...
            <div class="container" style="width: 35%; margin: auto;">
                <form class="form" action="cart.php?action=thanhtoan" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="sdt" value="<?php echo $sdt['sdt'] ?>">
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="pttt"> Phương thức thanh toán:</label>
                        <select class="form-select" name="pttt" aria-placeholder="Chọn phương thức thanh toán">
